...
type ConfigType<K extends keyof ConfLoaderRegistry, V extends (VersionString & keyof ConfLoaderRegistry[K])> = ConfLoaderRegistry[K][V];
...
interface WriteOptions<K extends keyof ConfLoaderRegistry, V extends (VersionString & keyof ConfLoaderRegistry[K])> {
  /** Name of the config */
  name: K;
  /** The Version you want to write */
  version: Exclude<V, 'latest'>,
  /** Its object representation */
  preset: ConfigType<K, V>;
